...
export default function ColumnSettingsModal({ columnSettings, resetColumns, setShowColumnSettings, showColumnSettings, theme, toggleColumn, visibleColumns }: ColumnSettingsModalProps) {
  return (
    <>
