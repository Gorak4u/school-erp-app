 ...
 * Based on SearchPerformanceMonitor architecture
 */
...
interface RefundPerformanceMonitorProps {
  theme: 'dark' | 'light';
  engine: {
...
export default function RefundPerformanceMonitor({ theme, engine }: RefundPerformanceMonitorProps) {
  ...
  if (!isVisible) {
    return (
      <button
        ...
        title="Show Refund Search Performance Monitor"
      >
        📊
      </button>
    );
