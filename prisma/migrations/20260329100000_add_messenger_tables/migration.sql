...
-- AddForeignKey
ALTER TABLE "school"."MessengerConversation" ADD CONSTRAINT IF NOT EXISTS "MessengerConversation_schoolId_fkey" FOREIGN KEY ("schoolId") REFERENCES "saas"."School"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "school"."MessengerConversation" ADD CONSTRAINT IF NOT EXISTS "MessengerConversation_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "school"."User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "school"."MessengerConversationParticipant" ADD CONSTRAINT IF NOT EXISTS "MessengerConversationParticipant_schoolId_fkey" FOREIGN KEY ("schoolId") REFERENCES "saas"."School"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "school"."MessengerConversationParticipant" ADD CONSTRAINT IF NOT EXISTS "MessengerConversationParticipant_conversationId_fkey" FOREIGN KEY ("conversationId") REFERENCES "school"."MessengerConversation"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "school"."MessengerConversationParticipant" ADD CONSTRAINT IF NOT EXISTS "MessengerConversationParticipant_userId_fkey" FOREIGN KEY ("userId") REFERENCES "school"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "school"."MessengerMessage" ADD CONSTRAINT IF NOT EXISTS "MessengerMessage_schoolId_fkey" FOREIGN KEY ("schoolId") REFERENCES "saas"."School"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "school"."MessengerMessage" ADD CONSTRAINT IF NOT EXISTS "MessengerMessage_conversationId_fkey" FOREIGN KEY ("conversationId") REFERENCES "school"."MessengerConversation"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "school"."MessengerMessage" ADD CONSTRAINT IF NOT EXISTS "MessengerMessage_senderId_fkey" FOREIGN KEY ("senderId") REFERENCES "school"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "school"."MessengerMessage" ADD CONSTRAINT IF NOT EXISTS "MessengerMessage_replyToId_fkey" FOREIGN KEY ("replyToId") REFERENCES "school"."MessengerMessage"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "school"."MessengerMessageReadReceipt" ADD CONSTRAINT IF NOT EXISTS "MessengerMessageReadReceipt_schoolId_fkey" FOREIGN KEY ("schoolId") REFERENCES "saas"."School"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "school"."MessengerMessageReadReceipt" ADD CONSTRAINT IF NOT EXISTS "MessengerMessageReadReceipt_messageId_fkey" FOREIGN KEY ("messageId") REFERENCES "school"."MessengerMessage"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "school"."MessengerMessageReadReceipt" ADD CONSTRAINT IF NOT EXISTS "MessengerMessageReadReceipt_userId_fkey" FOREIGN KEY ("userId") REFERENCES "school"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "school"."MessengerMessageReaction" ADD CONSTRAINT IF NOT EXISTS "MessengerMessageReaction_schoolId_fkey" FOREIGN KEY ("schoolId") REFERENCES "saas"."School"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "school"."MessengerMessageReaction" ADD CONSTRAINT IF NOT EXISTS "MessengerMessageReaction_messageId_fkey" FOREIGN KEY ("messageId") REFERENCES "school"."MessengerMessage"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "school"."MessengerMessageReaction" ADD CONSTRAINT IF NOT EXISTS "MessengerMessageReaction_userId_fkey" FOREIGN KEY ("userId") REFERENCES "school"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
